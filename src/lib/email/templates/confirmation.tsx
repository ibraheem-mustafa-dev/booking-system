...
// ---------------------------------------------------------------------------
// Booking Confirmation — sent to the CLIENT after a booking is created
// ---------------------------------------------------------------------------

export interface ConfirmationEmailProps {
  /** Client's first/display name */
  clientName: string;
  /** Name of the booking type (e.g. "Discovery Call") */
  bookingTypeName: string;
  /** Human-readable date (e.g. "Monday, 15 March 2026") */
  dateFormatted: string;
  /** Human-readable time (e.g. "10:00 AM") */
  timeFormatted: string;
  /** IANA timezone label (e.g. "Europe/London") */
  timezone: string;
  /** Duration in minutes */
  durationMins: number;
  /** Physical location (if in-person booking) */
  location?: string;
  /** Video call link (if online booking) */
  videoLink?: string;
  /** Host's display name */
  hostName: string;
  ...
  /** URL for rescheduling (token-based, no auth required) */
  rescheduleUrl?: string;
  /** URL for cancellation (token-based, no auth required) */
  cancelUrl?: string;
...
export function ConfirmationEmail({
  ...
  return (
    <EmailLayout
      previewText={`Booking confirmed: ${bookingTypeName} on ${dateFormatted}`}
      orgName={orgName}
